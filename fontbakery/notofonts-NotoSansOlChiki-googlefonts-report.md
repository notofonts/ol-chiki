...
</div></details><br></div></details><details><summary><b>[8] NotoSansOlChiki[wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Noto fonts must have an ARTICLE.en_us.html file (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/description/noto_has_article">com.google.fonts/check/description/noto_has_article</a>)</summary><div>
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tifinagh, tai-le, coptic, old-permic, canadian-aboriginal, malayalam, math, syriac
...
Or you can add the above codepoints to one of the subsets supported by the font: `latin`, `latin-ext`, `ol-chiki` [code: unreachable-subsetting]
...
Your font does *not* cover the following languages that require the soft-dotted feature: Avokaya (Latn, 100,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Koonzime (Latn, 40,000 speakers), Lugbara (Latn, 2,200,000 speakers), Kom (Latn, 360,685 speakers), Igbo (Latn, 27,823,640 speakers), Sar (Latn, 500,000 speakers), Navajo (Latn, 166,319 speakers), Ejagham (Latn, 120,000 speakers), Ma’di (Latn, 584,000 speakers), Nateni (Latn, 100,000 speakers), Ebira (Latn, 2,200,000 speakers), Basaa (Latn, 332,940 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Gulay (Latn, 250,478 speakers), Aghem (Latn, 38,843 speakers), Dan (Latn, 1,099,244 speakers), Mango (Latn, 77,000 speakers). [code: soft-dotted]
